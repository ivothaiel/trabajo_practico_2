...
public class FelinoSalvaje {
	...
	public String toString() {
		return "FelinoSalvaje [Nombre=" + Nombre + ", Edad=" + Edad + ", Peso=" + Peso + ", getNombre()=" + getNombre()
				+ ", getEdad()=" + getEdad() + ", getPeso()=" + getPeso() + ", getClass()=" + getClass()
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FelinoSalvaje other = (FelinoSalvaje) obj;
